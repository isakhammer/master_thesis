...
\newpage
\section{Hybrid Symmetric Interior Penalty DG Method on Heat Equation}%
...
\mathcal{T}_{h} $. This can be added to lhs on \eqref{eq:3c2} such that,
...
We then end up with the need to solve linear system.
