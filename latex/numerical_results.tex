...
\begin{figure}
    ...
    \centering
    \subfloat[]{\label{fig:ex1_conv:a}\includegraphics[scale=.2]{figures/convergence/L_1.0_m_1_r_1/conv_order_2_gamma_9.0.png}}
    \end{minipage}%
    \begin{minipage}{.5\linewidth}
    \centering
    \subfloat[]{\label{fig:ex1_conv:b}\includegraphics[scale=.2]{figures/convergence/L_1.0_m_1_r_1/conv_order_3_gamma_18.0.png}}
    \end{minipage}\par\medskip
    \centering
    \subfloat[]{\label{fig:ex1_conv:c}\includegraphics[scale=.2]{figures/convergence/L_1.0_m_1_r_1/conv_order_4_gamma_30.0.png}}
...
% \input{figures/convergence/convergence_d_2.tex}
