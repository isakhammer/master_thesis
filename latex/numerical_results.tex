...
\begin{figure}[tbh!]
    ...
    \end{minipage}%
    \centering
    \caption{The manufactured solution \eqref{eq:man_sol} with the model parameters $L=1$, $m=7$ and $r=3$ in $\Omega = (0,1)^2$ illustrated in \ref{fig:sol_l1_m7_r3} and the model parameters $L=2 \pi$, $m=1$ and $r=1$ in $\Omega = (0,2\pi)^2$ illustrated
