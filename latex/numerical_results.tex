...
% Gammas for L=1
\begin{table}
  \caption{\label{tab:ex1_order2} Order 2 gamma 9.}
...
% \end{table}
% \begin{table}
  \caption{\label{tab:ex1_order3}Order 3 gamma 18.}
  \begin{tabular}{rrrrrrr}
    \hline\hline
    \textbf{$h/{L} $} & \textbf{$L^2$ norm} & \textbf{EOC} & \textbf{$H_1$ norm} & \textbf{EOC} & \textbf{energy norm} & \textbf{EOC} \\\hline
  ...
  \end{tabular}
% \end{table}
  \caption{\label{tab:ex1_order4}Order 4 gamma 30.}
% \begin{table}
  \begin{tabular}{rrrrrrr}
    \hline\hline
    \textbf{$h/{L} $} & \textbf{$L^2$ norm} & \textbf{EOC} & \textbf{$H_1$ norm} & \textbf{EOC} & \textbf{energy norm} & \textbf{EOC} \\\hline
...
% Gammas for L=2pi
\begin{table}
  \caption{\label{tab:ex2_order2} Order 2 gamma 9.}
  \begin{tabular}{rrrrrrr}
    \hline\hline
    \textbf{$h/{L} $} & \textbf{$L^2$ norm} & \textbf{EOC} & \textbf{$H_1$ norm} & \textbf{EOC} & \textbf{energy norm} & \textbf{EOC} \\\hline
...
% \begin{table}
  \caption{\label{tab:ex2_order3} Order 3 gamma 18.}
  \begin{tabular}{rrrrrrr}
    \hline\hline
    \textbf{$h/{L} $} & \textbf{$L^2$ norm} & \textbf{EOC} & \textbf{$H_1$ norm} & \textbf{EOC} & \textbf{energy norm} & \textbf{EOC} \\\hline
...
% \begin{table}
  \caption{\label{tab:ex2_order4} Order 4 gamma 30. s}
  \begin{tabular}{rrrrrrr}
    \hline\hline
    \textbf{$h/{L} $} & \textbf{$L^2$ norm} & \textbf{EOC} & \textbf{$H_1$ norm} & \textbf{EOC} & \textbf{energy norm} & \textbf{EOC} \\\hline
