...
\todo[inline]{ Should we require $ v \in V =  \left\{ v \in H^{1}\left( \Omega  \right): v_{T} \in  H^{4}\left( T \right) \ \forall T \in \mathcal{T}_{h} \text{ and } \partial _{n} v = 0 \text{ on } \partial \Omega \right\}   \cap C^{0} (
\Omega  ) $  ??  }
...
\mathcal{T}_{h}    \right\}
\]
\todo[inline]{ Again as above. Should we require $ v \in V =  \left\{ v \in C^{0}\left( \Omega  \right): v_{T} = v | _{T} \in P_{2}\left( T \right), \forall T \in
\mathcal{T}_{h}  \text{ and } \partial _{n} v = 0 \text{ on } \partial \Omega  \right\} $ ?  }
and
\[
V_{h}^{*} = \begin{cases}
    V_{h} & \text{ if } \alpha  > 0 \\
...
\end{split}
\end{equation}
\todo[inline]{ Is the external summation correct? }
and
\begin{equation}
\label{eq:CP_F_h}
...
& - (\partial _{nt} w_{h}, \partial _{t}v_{h})_{\mathcal{F} _{h}^{ext}} -  (\partial _{nt} w_{h}, \partial _{t}v_{h})_{\mathcal{F} _{h}^{ext}}
\end{split}
\end{equation}

\todo[inline]{ TODO: correct the error analysis with this $\mathcal{A} _{h}$ including external facets $\mathcal{F} _{h}^{ext}$  }
