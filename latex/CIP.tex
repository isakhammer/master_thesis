...
\centering
\subfloat[]{\label{main:a}\includegraphics[scale=.15]{figures/refinements/n10.png}}
\end{minipage}%
\begin{minipage}{.4\linewidth}
\centering
\subfloat[]{\label{main:b}\includegraphics[scale=.15]{figures/refinements/n20.png}}
\end{minipage}\par\medskip
\centering
\subfloat[]{\label{main:c}\includegraphics[scale=.15]{figures/refinements/n40.png}}

\caption{Illustration of mesh on the unit square $\Omega = (0,L)^{2} \subseteq  \mathbb{R} ^{2}$ with triangulation $\mathcal{T} _{h}$. Here is $h = \left\{ L /10, L /20,L /40 \right\}$.
}
\label{fig:main}
\end{figure}
...
.\end{equation*}
An visualization of \eqref{eq:man_sol} can be seen n fucute

For all experiments carried out will we define $\alpha  = 1 $. We also choose the penalty paramter to be $1$, even though the only requirement according to the results in subsection \ref{ssub:coercitivity} is that $\gamma \ge  \frac{1}{2}$.
...
\begin{figure}[htpb]
    ...
    \caption{Convergence on domain. }
    \label{fig:conv_order}
\end{figure}


\begin{figure}[htpb]
    \centering
    \includegraphics[width=0.8\textwidth]{figures/convergence/convergence_d_1.png}
    \caption{Convergence on domain. $d=1$  }
    \label{fig:conv_d1}
\end{figure}

\begin{figure}[htpb]
    \centering
    \includegraphics[width=0.8\textwidth]{figures/convergence/convergence_d_2.png}
    \caption{Convergence on domain. $d=2$  }
    \label{fig:conv_d2}
\end{figure}

\begin{figure}[htpb]
    \centering
    \includegraphics[width=0.8\textwidth]{figures/convergence/convergence_d_3.png}
    \caption{Convergence on domain. $d=3$  }
    \label{fig:conv_d3}
\end{figure}

\begin{figure}[htpb]
    \centering
    \includegraphics[width=0.8\textwidth]{figures/convergence/convergence_d_4.png}
    \caption{Convergence on domain. $d=4$  }
    \label{fig:conv_d4}
\end{figure}
