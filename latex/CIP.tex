...
continuous jump. For symmetric purposes we also added $ \left( \mean{ \partial _{nn} v_{h}}  , \jump{ \partial _{n} w_{h} }  \right)_{F} $. Similarly for the summation over the external facets $\mathcal{F} _{h}^{ext}$ we added the term $- \left( \partial
