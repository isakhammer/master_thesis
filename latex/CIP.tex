...
\]
We can observe that for the second step must
\[
\begin{split}
\| \nabla ^2w_{h} \|_{\mathcal{T}_{h}   }^{  }  \| \nabla ^2v_{h} \|_{\mathcal{T}_{h}   }^{  } & \le \| w_{h} \|_{ a_{h} }^{  } \| v_{h} \|_{ a_{h} }^{  }, \\
C_{j}^{\frac{1}{2}}\|  \nabla ^2 w_{h} \|_{ \mathcal{T} _{h} }^{ } \| h^{-\frac{1}{2}} \jump{ \partial _{n} v_{h} }   \|_{ \mathcal{F} _{h} }^{  }  & \le \| w_{h} \|_{ a_{h} }^{  } \| v_{h} \|_{ a_{h} }^{  }, \quad \quad C_{j}^{\frac{1}{2}}\|  \nabla
