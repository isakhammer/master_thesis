...
\todo[inline]{ Compact notation \eqref{eq:CP_A_h}  has to be redone since $\mathcal{A} _{h} $ is changed because of the $\mathcal{F}_{h}^{ext}$ summation, and likewise correct the error analysis.}
