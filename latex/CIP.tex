...
The stability and interpolation properties of the Cléments interpolation operator has in fact proven to be useful. Cléments lemma  
\[
...
\[
    \begin{split}
      ...
      \right) \\
      m +\frac{1}{2}\le l \le k+1  \implies \| v - C_{h} v \|_{ m,2,F }^{  } & \lesssim h^{l-m- \frac{1}{2}}_{T} \| v \|_{l,2,\omega \left( T \right)  }^{  } \quad  \forall \partial T \in \mathcal{T} _{h}, \forall v \in H^{l}\left( \omega \left( F \right)  \right)
    \end{split}
\]
