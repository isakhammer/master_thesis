...
\begin{split}
 ...
 a\left( v,v \right)    & = \frac{1}{2} \| \nabla u  \|_{ \Omega  }^{  2} + \frac{1}{2} \| \nabla u  \|_{ \Omega  }^{  2} \ge \beta \left( \| u \|_{\Omega   }^{ 2 }  + \| \nabla u \|_{\Omega   }^{ 2 } \right) \ge \beta \| v \|_{\mathcal{V}   }^{  }
\end{split}
\]
 Here is $\beta = \min_{} \left\{ \frac{1}{2}, \frac{1}{2C^{2}} \right\} $ where the last inequality was the Poincare inequality applied, i.e., there exists a $C>0$  such that $\| u \|_{ \Omega  }^{  } \le C  \| \nabla u \|_{\Omega   }^{  } $. Hence, the weak formulation \eqref{eq:poissons_weak_formulation} is well posed.
