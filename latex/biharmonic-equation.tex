...
\begin{split}
    ...
    \partial _{n} u & = g_1 \quad \text{on } \partial \Omega  \\
    \partial _{n} \nabla ^2 u & = g_{2} \quad \text{on } \partial \Omega   \\
\end{split}
.\end{equation}
We will assume for now that $u \in H^{4}\left( \Omega  \right) $, $\gamma $ is nonnegative constants and $f \in L_{2}\left( \Omega  \right) $. Such problems as \eqref{eq:bi_problem} are often associated with the Cahn-Hilliard model
...
a\left( u,v \right)_{\Omega } = \left( f,v \right)_{\Omega } - \left<g_{2},v \right>_{\partial \Omega } + \left<\nabla g_{1}, \nabla v \right>_{\partial \Omega }  \quad \forall v \in
V
.\end{equation}
