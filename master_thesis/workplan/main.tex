...
\begin{table}[htpb]
    ...
    \hline &&&&& \\[-1em] % Alignmenttrick https://tex.stackexchange.com/a/316016
        ...
        \begin{itemize}[leftmargin=3mm]
            \item Analysis \begin{todolist}[noitemsep]
                \item[\done] \textcolor{red}{Initial problem setup}
                    \item \textcolor{red}{Coercivity}
                    \item \textcolor{red}{Boundedness}
...
\ganttbar[progress=20]{Phase 2}{7}{12} \\
...
\begin{itemize}
    \item Very productive since last time. Mostly been busy verifying every single sentence in \cite{gurkan2019stabilized}. There is some minor details here and there, but I agree very much with the proofs.
    \item Here is some numerical results.
