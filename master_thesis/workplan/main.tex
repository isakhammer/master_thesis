...
\begin{table}[htpb]
    ...
    \hline &&&&& \\[-1em] % Alignmenttrick https://tex.stackexchange.com/a/316016
        ...
        \begin{itemize}[leftmargin=3mm]
            ...
            \item Implementation
                \begin{todolist}[noitemsep]
                \item[\done]{CIP Nitsche Implementation}
                \item[\done] {CutCIP Implementation}
                \item[\done] First plot
                \item \textcolor{red}{$ L^{2}$ convergence}
                \item \textcolor{red}{$a,*$ convergence}
                \end{todolist}
        \end{itemize}
...
\ganttbar[progress=90]{Phase 2}{7}{12} \\
