    ...
    \hline &&&&& \\[-1em] % Alignmenttrick https://tex.stackexchange.com/a/316016
        ...
        \begin{itemize}[leftmargin=3mm,noitemsep]
            ...
            \item Implementation
                ...
                \item Poisson Cut
                    ...
                    \end{todolist}
                     \textbf{ Only convergence for $k=1$? }
        ...
        \begin{todolist}[leftmargin=3mm, noitemsep]
            ...
            \item Mathematical background
                \begin{todolist}[leftmargin=3mm, noitemsep]
                \item[\done]  Computational domains
                \item Broken Sobolev Spaces
                \item Inverse estimates
                \end{todolist}
