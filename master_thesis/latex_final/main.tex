...
formulation to a wider range of physical problems, we need to take these factors into consideration. Numerically speaking, the natural progression would be to incorporate adaptive schemes for both spatial and transient discretization.
