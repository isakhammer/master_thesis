...
\label{eq:bi_problem}
\end{subequations}
Here $\Delta ^2 = \Delta  \left( \Delta  \right) $ is the biharmonic operator, also known as the bilaplacian. We will assume for the strong form that $u \in H^{4}\left( \Omega  \right) $, $\alpha  >0 $ and $f \in L^{2}\left( \Omega  \right)
