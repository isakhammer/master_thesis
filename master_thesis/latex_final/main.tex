...
\begin{abstract}
The fourth-order Cahn-Hilliard equation, with its wide range of applications in phase-separation, poses numerical challenges due to its non-linear and stiff nature and fourth-order derivatives. This thesis introduces a novel, stabilized,
...
Nå som jeg sitter på bussen til Oppdal for å delta på et 10-dagers fallskjermskurs, og samtidig skriver slutten på masteroppgaven, vil jeg også benytte anledningen til å takke rammeverket som har gjort denne mastergraden mulig.

For sluttfasen går definitivt den største takken til min masterveileder, André Massing.
Å skrive masteroppgave bir plutselig mye mer morsomt når man blir inkludert i forskningsgruppa og. Ikke bare blir man eksponert for litt faglige diskusjoner, men nyskjerrigheten og entuiasmen når man gjør noe helt nytt som kanskje ikke er gjort før.

men også til tider ekstrem tålmodighet og moralsk støtte.
  Også takk for mang en runder

En takk til ansatte på Institutt for Matematiske fag på NTNU for å ikke bare opprettholde et høyt faglig og pedagogisk nivå, men også for å investere i studentene. Det er ikke alltid like lett med fire eksamener innen et tidsrom på to til tre uker, og da setter mange, som meg, stor pris på at foreleserne er veldig positive og åpne for å legge opp til et nytt forsøk om det trengs. Ut fra erfaring er det faktisk når man øver til andre forsøk i stillhet i august at man virkelig lærer mest!

Også en stor takk til Høiskolen Chemikerforening (HC) for å gi meg en fantastisk sosial arena. Har sikkert blitt et par tusen timer på Kontoret gjennom min tid på Gløs. Solid takk til Kongliga Kemisektionen på KTH for at vi i HC får komme på besøk en gang i
året for å ha det gøy!

Sist, men ikke minst, stor takk til tålmodigheten til både Mamma og Pappa som fortsatt vil ha meg hjem til jul.  sikkert kunne hjulpet mer med å lag maten og vaske huset.
\vspace{10pt}
Isak Hammer,  8. Juli 2023.
