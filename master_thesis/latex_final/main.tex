...
The BH problem holds relevance since it provides a proper spatial-discretization test framework prior to moving on solving the nonlinearities and time-integration.
