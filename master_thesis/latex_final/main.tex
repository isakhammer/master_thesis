...
unfitted cut continuous interior penalty finite element method specifically designed for the biharmonic problem with Cahn-Hilliard type boundary conditions which successfully we extended to handle the Cahn-Hilliard equation. Our approach combines the theoretical cut
...
\vspace{1cm}
 ...
 penalty finite element metode spesifikt utviklet for det biharmoniske problemet med Cahn-Hilliard-liknende randbetingelser, og deretter utvidet for å håndtere Cahn-Hilliard-ligningen. Ideen er p anvende det teoretiske rammeverket for discontinuous Galerkin
