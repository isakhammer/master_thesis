...
Now, in the context of the biharmonic problem. First of all, int the numerical implementation we only considered element of order $k=2$, hence, it remains to exploit higher order, i.e. $k=3,4$. It would also be interesting to compare this method to other
