...
\begin{block}{ $C^0$ Interior penalty method. }
...
\begin{block}{CutFEM}
    \begin{itemize}
        \item Elegant method to solve the numerical anomalies when integrating cut cells.
        \item Utilizing so-called ghost penalties to ensure well-posedness of the numerical scheme.
    \end{itemize}
\end{block}
