...
\begin{frame}
    \begin{block}{Why Finite element method}
        \begin{itemize}
            \item Can utilize the domain because of its generalizations on domains
            \item Can easily handle several polynomial basis
            \item Very nice formulations
        \end{itemize}
    \end{block}

    \begin{block}{Challenges}
            \item May be difficult to handle higher order problems
    \end{block}
