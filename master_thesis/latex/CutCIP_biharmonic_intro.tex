...
\begin{figure}[b]
    ...
    \begin{minipage}{0.4\textwidth}
        ...
        \end{tikzpicture}
    \end{minipage}
        \caption{Two examples of bad cut cells.  Then is it clear that  $\abs{ \Gamma \cap T } \lesssim  h^{d-1}$ and $\abs{ \Omega  \cap T } \lesssim  \varepsilon  h^{d}$, where $\varepsilon $ is arbitrary
small . }
