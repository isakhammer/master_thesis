...
We propose using applying the so-called cut finite element method \cite{burman2015cutfem}.
The concept is to generate a structured background mesh which fully covers $\Omega $, but does not necessarily fit to the boundary perfectly.
