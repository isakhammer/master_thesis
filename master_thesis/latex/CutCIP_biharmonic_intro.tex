...
Inspired by a corresponding CutFEM DG elliptic framework \cite{gurkan2019stabilized} and starting from the CIP methods introduced in Section \ref{sec:CIP_biharmonic_problem}, is the goal in this section to engineer suitable stabilized ghost penalty
terms for the biharmonic problem.
