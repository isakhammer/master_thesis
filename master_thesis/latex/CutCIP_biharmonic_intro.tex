...
\begin{remark}
    ...
    Figure \ref{fig:example_patch} we can obviously observe that the relationship $ \abs{ \Gamma \cap T }_{d-1} / \abs{ T\cap \Omega }_{d}   $ may in fact diverge for bad cut configurations and, thus, makes it necessarry to extend the norm to the full element $T$ for the inequality to holds.
\end{remark}
