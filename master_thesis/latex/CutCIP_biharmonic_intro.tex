...
$a_{h}:V_{h}
\times V_{h} \to  \mathbb{R}  $ and the linear form $l_{h}: V_{h} \to \mathbb{R} $.

Recall the recall the Hessian formulation \eqref{eq:hessian_prob} and the Laplace formulation \eqref{eq:laplace_prob} on a polygonal mesh. Then we have the following
unfitted variants.
