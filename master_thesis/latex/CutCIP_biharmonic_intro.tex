...
\begin{figure}[t]
    ...
    \end{tikzpicture}
\caption{Illustration of the fat intersection property. Let $T \in \mathcal{T}_{\Gamma } $. Then is it clear that  $\abs{ \Gamma \cap T } \lesssim  h^{d-1}$ and $\abs{ \Omega  \cap T } \lesssim  \varepsilon  h^{d}$, where $\varepsilon $ is arbitrary
