...
We want to devise a CutFEM based on the CIP formulation for the biharmonic problem. Let $\widetilde{\mathcal{T}_{h} } $ be a shape-regular and quasi-uniform mesh. Let us denote the active set $\mathcal{T} _{h} \subseteq \widetilde{\mathcal{T}_{h}}$ which intersects the interior of the active domain $\Omega $, that is  \[
