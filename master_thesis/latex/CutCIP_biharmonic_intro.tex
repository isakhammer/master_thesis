...
\begin{proof}
         ...
         \end{equation}
             ...
             \[
\abs{ ( \mathrm{VII} )  }  \lesssim \| v \|_{ A_{h} }^{  }
\| w \|_{ A_{h} }^{  } .
             \]

             Hence, we have showed that all terms in $a_{h}( \cdot ,\cdot ) $ is bounded in the $\|\cdot   \|_{A_{h}  }^{  } $ norm.
         ...
         %                                             & + \left( \mean{  \partial _{n n} v }, \jump{ \partial _{n }w} \right)_{\mathcal{F}_{h}^{} \cap \Omega}     + \left( \mean{ \partial _{nn } w }, \jump{ \partial _{n}v }
         %                                             \right)_{\mathcal{F}_{h}^{} \cap \Omega}+ \frac{\gamma }{h}  \left( \jump{ \partial _{n} v}, \jump{ \partial _{n} w   }   \right)_{\mathcal{F}_{h}^{} \cap \Omega}   \\
         %                                             & + \left(  \partial _{n n} v ,  \partial _{n }w \right)_{\Gamma } + \left(  \partial _{n n} w ,  \partial _{n}v       \right)_{\Gamma }   + \frac{\gamma }{h}  \left(  \partial _{n} v,  \partial _{n} w \right)_{\Gamma }
         %            \end{split}
         %        \end{equation}
