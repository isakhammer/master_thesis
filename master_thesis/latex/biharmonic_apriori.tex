...
Hence, the first part of the proof is complete.
    ...
    \begin{split}
        ...
        &= a_{h}(e, \phi -  C_{h}^{e} \phi   ) + g_{h}(u_{h} - C_{h}^{e} u,   \pi^{e}_{h} \phi   )  +g_{h}(\pi _{h} u, C_{h}^{e} \phi   ) \\
    ...
    a_{h}( e, \phi ) & = a_{h}( e, \phi  - C^{e} _{h} \phi ) + a_{h}( u - u_{h}, C^{e} _{h} \phi ) \\
     ...
     & = a_{h}( e, \phi  - C^{e} _{h} \phi ) + g_{h}(  u_{h} - C ^{e}_{h}u, C^{e} _{h} \phi )+ g_{h}( C ^{e}_{h}u, \pi _{h} \phi ).
        \end{split}
    \]
...
\[
    \begin{split}
        ...
        \abs{ C^{e} _{h} u - u_{h} } _{g_{h}} &\lesssim \|  \pi^{e} _{h} u - u_{h} \|_{ A_{h}  }^{  }  \\
