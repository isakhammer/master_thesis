...
Let us define the flux to be proportional to the gradient of the chemical energy, then is  $\mathcal{J} = - M  \nabla \mu  $.
...
\frac{d}{dt} E( u)  \le  0 \text{ and }\frac{d}{dt} \int_{\Omega }^{}  u dx = 0.
    \end{split}
\]
Remark that the computation of the inequality does utilize the assumption of $M$ to be constant.
