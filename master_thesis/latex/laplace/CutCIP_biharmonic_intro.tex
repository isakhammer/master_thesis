...
\begin{equation}
\|v\|_{a_{h}} ^{2}= \|\Delta v\|_{ \mathcal{T}_{h} }^2 + h^3   \| \left\{\partial_n \Delta v\right\} \| _{\mathcal{F}_{h} }^2 + h^{-3} \| \jump{ v } \|_{\mathcal{F}_{h} }^{2}
+ h \| \mean{ \Delta v } \|_{ \mathcal{F}_{h}^{ext}   }^{2  } + h^{-1} \| \jump{ \partial_n v } \|_{ \mathcal{F}_{h}^{ext}  }^{2  }    \right) . \\
\end{equation}
\begin{remark}
