...
\todo[inline]{ Do the derivation. See \cite[Equation]{feng2007fully} for inspiration. }
...
\begin{equation}
 \|v\|_{a_{h}} ^{2}= \sum_{K \in \mathcal{T}_h}\|\Delta v\|_K^2+\sum_{c \in \mathcal{E}^J}\left(h_c^3 \abs{  \left\{\partial_n \Delta v\right\}}_c^2 + h_c^{-3}  \abs{ \jump{ v } }_e^2\right)\right + \sum_{e \in \mathcal{E}}\left(h_e \abs{ \mean{
 \Delta v } } _e^2+h_e^{-1}\abs{ \jump{ \partial_n v } }   _c^2\right) . \\
\end{equation}
\begin{remark}
