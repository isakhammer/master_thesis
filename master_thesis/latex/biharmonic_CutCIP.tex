...
\begin{proof}
    ...
    \begin{enumerate}[label=\arabic*)]
        \item The goal is to prove the inequality \eqref{eq:bi_A_h_bounded}. \[
                ...
                \begin{equation}
                    \begin{split}
                        a_{h} \left( v, w \right)   =&   \left( \alpha  v, w \right) _{\mathcal{T} _{h} \cap \Omega }   +  \left( D^2 v, D^2w \right) _{\mathcal{T} _{h} \cap \Omega} \\
                                                     & +
                                                     \left( \mean{  \partial _{n n} v }, \jump{ \partial _{n }w} \right)_{\mathcal{F}_{h} \cap \Omega}  +
                                                     \left( \mean{ \partial _{n n} v }, \jump{ \partial _{n}w }      \right)_{\mathcal{F}_{h} \cap \Omega}
                                                     \\
                                                     & + \frac{\gamma }{h}  \left( \jump{ \partial _{n} v}, \jump{ \partial _{n} w   }   \right)_{\mathcal{F}_{h} \cap \Omega} \\
                    \end{split}
                \end{equation}
    \end{enumerate}
\end{proof}
