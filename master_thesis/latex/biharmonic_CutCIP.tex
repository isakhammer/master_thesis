...
& \ge - \frac{1}{\varepsilon } C  (\| D^2 v \|_{ \mathcal{T} _{h} }^{ 2 }  + \abs{ v } _{ g_{h} }^{2  } ) -  \varepsilon \|h^{-\frac{1}{2}}  \partial _{n} v    \|_{ \Gamma    }^{2  } \\
    ...
    \[
    \begin{split}
       a_{h}( v,v)  \ge&    \|\alpha v  \|_{ \mathcal{T}_{h}\cap  \Omega   }^{2} + (1  - \frac{1}{\varepsilon } 4C)  (\| D^2 v \|_{ \mathcal{T} _{h} }^{ 2 }  + \abs{ v } _{ g_{h} }^{2  } )  \\
    ...
    Setting $\varepsilon = 8C$ and $\gamma = \frac{33}{2} C$ we simplify the problem to \[
        \begin{split}
           a_{h}( v,v)  \ge&    \|\alpha^{\frac{1}{2}} v  \|_{ \mathcal{T}_{h}\cap  \Omega   }^{2} + \frac{1}{2}  (\| D^2 v \|_{ \mathcal{T} _{h} }^{ 2 }  + \abs{ v } _{ g_{h} }^{2  } )  \\
