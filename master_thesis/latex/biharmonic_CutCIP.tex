...
\item
     ...
     Hence, by \eqref{eq:bi_projection_estimates_2}  \[
       ...
       \lesssim h^{-2} \|   \nabla  ( u - C_{h}^{e}u )    \|_{ \partial \mathcal{T} _{h} }^{2  }     \\
                                                                                                                 &\lesssim h^{-2} \|      u - C_{h}^{e}u     \|_{1, \partial \mathcal{T}_{h} }^{2  }
                                                                                                                 \lesssim h^{ 2(s - r - \frac{1}{2}) -2 } \sum_{T \in \mathcal{T}_{h} }^{}
                                                                                                                  \| u      \|_{ s, \omega (  F)  }^{  2}
        \end{split}
    \]
    \todo[inline]{
        ...
        \[
     \|      u - C_{h}^{e}u     \|_{1, \partial \mathcal{T}_{h} }^{2  }
