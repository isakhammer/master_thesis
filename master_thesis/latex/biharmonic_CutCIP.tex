...
\todo[inline]{ Seems like \eqref{eq:bi_projection_estimates_3} might be wrong.  }
...
\begin{proof}
    ...
    \[
            \| |\alpha |^{\frac{1}{2}} ( u - C_{h}^{e}u) \|_{ \mathcal{T} _{h} \cap \Omega  }^{ 2}  \le  \| \alpha  \|_{L^\infty ( \Omega )    }^{2  }   \|  ( u - C_{h}^{e}u) \|_{ \mathcal{T} _{h}  }^{ 2} \lesssim  h^{2(s-r)} \sum_{T \in \mathcal{T}
            _{h}}^{}   \| v \|_{2,w( T)  }^{  2}
    \]
    Here we simply used \eqref{eq:bi_projection_estimates_1}.
    Similarly for the second term \[
    \| D^2 ( u - C_{h}^{e}u ) \|_{\mathcal{T} _{h} \cap \Omega   }^{ 2 } \le \| D^2 ( u - C_{h}^{e}u ) \|_{\mathcal{T} _{h} \cap \Omega   }^{ 2 } \lesssim h^{-1} \|  \|_{  }^{  }
    \]
