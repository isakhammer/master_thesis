...
a_{h} \left( u, v \right)   =&   \left( \alpha  u, v \right) _{\mathcal{T} _{h} \cap \Omega }   +  \left( D^2 u, D^2v \right) _{\mathcal{T} _{h} \cap \Omega} \\
 ...
 & + ( \partial _{nn} u, \partial _{n} v)_{\Gamma } + ( \partial _{n} v, \partial _{nn} u)_{\Gamma }
 \\
...
\]
\begin{remark}
Note that it holds that $\mathcal{T} _{h} \cap  \Omega   = \Omega  $ and $\mathcal{T} _{h} \cap  \Gamma  = \Gamma $. Depending on context, we choose either notation.
\end{remark}
