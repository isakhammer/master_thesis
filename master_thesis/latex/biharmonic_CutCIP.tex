...
\begin{corollary}
    ...
    \[
    \inf_{v_{h} \in \mathcal{P} ^{k}_{c}( \Omega ) } \| v - v_{h} \|_{  m,2,\Omega }^{  } \le C h^{l-m}  \| v \|_{ l,2,\Omega  }^{  }    \forall v \in W_{l,2}( \Omega ).
    \]
\end{corollary}


This result is very useful since it is sufficient to show that a priori estimates holds given to prove convergence rate.
