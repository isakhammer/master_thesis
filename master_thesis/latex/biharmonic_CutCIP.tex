        ...
        \item The goal is to prove the inequality \eqref{eq:bi_A_h_bounded}. \[
             ...
             \]
              Now it remains to handle boundary terms. \[
                \abs{ ( \partial _{nn} v, \partial _{n} w)_{\Gamma } }  \lesssim \| h^{\frac{1}{2}}\partial _{nn} v \|_{\Gamma   }^{  } \| h^{-\frac{1}{2}} \partial _{n}w \|_{\Gamma   }^{  }  \lesssim \| h^{\frac{1}{2}}\partial _{n} v \|_{A_{h}  }^{  } \| w \|_{ A_{h}   }^{  }
             \]
             ...
             % part of the norm.}
             And finally, using the definition of the norm is it easily to see that,
             \[
...
\| w \|_{ a_{h} }^{  } .
             ...
             Obviously is $\| v \|_{a_{h}  }^{  } \lesssim \| v \|_{A_{h}  }^{  }$. Hence, $a_{h}$ is bounded in the $\|\cdot   \|_{A_{h}  }^{  } $ norm.
    \end{enumerate}
