...
On the strong form of the Cahn-Hilliard \eqref{eq:strong_ch} we have no analytical solution, so we cannot construct a manufactured solution. However, a way to check that the system does behave like expected based on the physical properties \eqref{eq:mass_cons_energy_decrease}. In other
...
\begin{figure}[]
    \centering
    \newlength\figwidth  % define a new length \figwidth
    \setlength\figwidth{0.4\textwidth}  % set the value of \figwidth
    \hfill
    \subfloat[$t=0\tau$]{\label{sub:fig:ill_c0}
        \includegraphics[width=\figwidth]{results/illustration/c0.png}
    }\hfill
    \subfloat[$t=2\tau$]{\label{sub:fig:ill_c2}
        \includegraphics[width=\figwidth]{results/illustration/c2.png}
    }
    \\
    \vspace{10pt}
    \hfill
    \subfloat[$t=10\tau$]{\label{sub:fig:ill_c10}
        \includegraphics[width=\figwidth]{results/illustration/c10.png}
    }
    \hfill
    \subfloat[t=50$\tau$]{\label{sub:fig:ill_c50}
        \includegraphics[width=\figwidth]{results/illustration/c50.png}
    }
    \\
    \vspace{10pt}
    \hfill
    \subfloat[$t=200\tau$]{\label{sub:fig:ill_c200}
        \includegraphics[width=\figwidth]{results/illustration/c200.png}
    }\hfill
    \subfloat[$t=1000\tau$]{\label{sub:fig:ill_c1000}
        \includegraphics[width=\figwidth]{results/illustration/c1000.png}
    }
    \caption{Illustration of simulations of the Cahn-Hilliard equation on the circle domain for $t\in \left[ 0, 1000\tau  \right] $.}
...
\begin{figure}[]
    ...
    \subfloat[$t=0\tau$]{\label{sub:fig:ill_f0}
        \includegraphics[width=\figwidth]{results/illustration/f0.png}
    }\hfill
    \subfloat[$t=2\tau$]{\label{sub:fig:ill_f2}
        \includegraphics[width=\figwidth]{results/illustration/f2.png}
    }
    \\
    \vspace{10pt}
    \hfill
    \subfloat[$t=10\tau$]{\label{sub:fig:ill_f10}
        \includegraphics[width=\figwidth]{results/illustration/f10.png}
    }
    \hfill
    \subfloat[t=50$\tau$]{\label{sub:fig:ill_f50}
        \includegraphics[width=\figwidth]{results/illustration/f50.png}
    }
    \\
    \vspace{10pt}
    \hfill
    \subfloat[$t=200\tau$]{\label{sub:fig:ill_f200}
        \includegraphics[width=\figwidth]{results/illustration/f200.png}
    }\hfill
    \subfloat[$t=1000\tau$]{\label{sub:fig:ill_f1000}
        \includegraphics[width=\figwidth]{results/illustration/f1000.png}
    }
