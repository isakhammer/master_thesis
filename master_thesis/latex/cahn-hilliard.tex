...
\label{eq:ch_exact}
    \begin{split}
        ...
        \varepsilon \partial _{n} \Delta u & = g_{2}(x)  \quad \text{ on } \Gamma  \\
    \end{split}
\end{equation}
...
\begin{equation}
    ...
    l_{h}( v_{}) & =  \left( h, v \right) _{\Omega } \red{- ( g_{2},  v )_{\Gamma } +\frac{1}{\varepsilon } (f(u),  v )_{\Gamma }} -  ( g_{1}, \Delta  v  )_{\Gamma }  + \frac{\gamma }{h} ( g_{1}, \partial _{n} v  )_{\Gamma }
    \end{split}
\end{equation}
