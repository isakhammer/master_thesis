...
words, we can check that our discrete solution satisfies the following conditions. Let $E^m = E( u_{h}^{m})$ do we expect that
\begin{equation}
 E^m   <  E^{ m-1 }
\end{equation}
...
\end{equation}
 Let us define global mass error and local mass error.
 \begin{equation}
