...
\begin{figure}[]
    ...
    \subfloat[$t=0\tau$]{\label{sub:fig:ill_c0}
        \includegraphics[width=0.4\textwidth]{results/illustration/c0.png}
    }\hfill
    \subfloat[$t=2\tau$]{\label{sub:fig:ill_c2}
        \includegraphics[width=0.4\textwidth]{results/illustration/c2.png}
    }
    \\
    \vspace{10pt}
    \hfill
    \subfloat[$t=10\tau$]{\label{sub:fig:ill_c10}
        \includegraphics[width=0.4\textwidth]{results/illustration/c10.png}
    }
    \hfill
    \subfloat[t=50$\tau$]{\label{sub:fig:ill_c50}
        \includegraphics[width=0.4\textwidth]{results/illustration/c50.png}
    }
    \\
    \vspace{10pt}
    \hfill
    \subfloat[$t=200\tau$]{\label{sub:fig:ill_c200}
        \includegraphics[width=0.4\textwidth]{results/illustration/c200.png}
    }\hfill
    \subfloat[$t=1000\tau$]{\label{sub:fig:ill_c1000}
        \includegraphics[width=0.4\textwidth]{results/illustration/c1000.png}
    }
...
\begin{figure}[]
    ...
    \subfloat[$t=0\tau$]{\label{sub:fig:ill_f0}
        \includegraphics[width=0.4\textwidth]{results/illustration/f0.png}
    }\hfill
    \subfloat[$t=2\tau$]{\label{sub:fig:ill_f2}
        \includegraphics[width=0.4\textwidth]{results/illustration/f2.png}
    }
    \\
    \vspace{10pt}
    \hfill
    \subfloat[$t=10\tau$]{\label{sub:fig:ill_f10}
        \includegraphics[width=0.4\textwidth]{results/illustration/f10.png}
    }
    \hfill
    \subfloat[t=50$\tau$]{\label{sub:fig:ill_f50}
        \includegraphics[width=0.4\textwidth]{results/illustration/f50.png}
    }
    \\
    \vspace{10pt}
    \hfill
    \subfloat[$t=200\tau$]{\label{sub:fig:ill_f200}
        \includegraphics[width=0.4\textwidth]{results/illustration/f200.png}
    }\hfill
    \subfloat[$t=1000\tau$]{\label{sub:fig:ill_f1000}
        \includegraphics[width=0.4\textwidth]{results/illustration/f1000.png}
    }
