...
\end{enumerate}
\begin{remark}
    Be aware that the formulations are equivalent in a continuous sense. Hence, if we replace $u \in H^{4}( \Omega ) $ with  $u_{h} \in  V_{h}$ we have two different discrete formulations.
\end{remark}
