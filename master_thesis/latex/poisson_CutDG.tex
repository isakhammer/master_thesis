...
for $ \forall v \in  H^{2}( \mathcal{T}_{h} ) + V_{h} $ and $ \forall u \in V_{h}$.
    ...
    \]
         ...
         Using Cauchy-Schwarz inequality \ref{lemma:cauchy-schwarz} is easy to see via assumption that this must hold \[
\left\lvert g_{h}( v,u)  \right\rvert \le \left\lvert v \right\rvert _{g_{h}} \left\lvert u \right\rvert _{g_{h}} \le \| v \|_{ A_{h} }^{  } \| u \|_{ A_{h} }^{  }
    ...
    \begin{itemize}
        \item By applying the assumption \ref{as:est_EP1} and \ref{cor:g_h_inverste_results} \[
\begin{split}
        \| \nabla v \|_{ \mathcal{T} _{h}\cap \Omega  }^{  }\| \nabla u \|_{ \mathcal{T} _{h} \cap \Omega  }^{  } & \le \| \nabla v \|_{ \mathcal{T} _{h}  }^{  }\| \nabla u \|_{ \mathcal{T} _{h}   }^{  } \\
...
\end{split}
        ...
        \item We can also observe that 
            \[
         \| \partial _{n}v \|_{ \Gamma   }^{  } \| u \|_{ \Gamma  }^{  } & \le  \ldots \\
            \] 
    \end{itemize}
    \[
    \begin{split}
