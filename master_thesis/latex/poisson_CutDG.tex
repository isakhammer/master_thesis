...
\begin{corollary}[Unfitted inverse estimates]
    ...
    Assume that $v \in V^{h} $ and let $\mathcal{T}_{h} $ be a active mesh. Then the following estimates holds,
    \[
\begin{split}
    \| \partial _{n} v \|_{ \mathcal{F}_h \cap \Omega  }^{  } & \le   C_{I} h ^{-\frac{1}{2}} \| \nabla v \|_{ \mathcal{T}_{h}  }^{  } \\
...
\end{split}
    ...
    \[
\begin{split}
    h^{\frac{1}{2}}\| \partial _{n} v \|_{ \mathcal{F}_h \cap \Omega  }^{  } & \le  C_{I}  \| \nabla v \|_{ \mathcal{T}_{h}  }^{  } \\
