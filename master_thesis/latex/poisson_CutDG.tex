...
\left\lvert g_{h}( v,u)  \right\rvert \le \left\lvert v \right\rvert _{g_{h}} \left\lvert u \right\rvert _{g_{h}} \le \| v \|_{ A_{h} }^{  } \| u \|_{ A_{h} }^{  }
    ...
    & + \| \mean{ \partial _{n}v }   \|_{\mathcal{F} _{h}\cap \Omega   }^{  } \| \jump{ u }   \|_{ \mathcal{F} _{h} \cap \Omega  }^{  } + \| \jump{ v }   \|_{ \mathcal{F_{h}}  }^{  }  \| \mean{ \partial _{n} u }    \|_{ \mathcal{F} _{h} \cap \Omega  }^{  } +
...
\begin{assumption}[EP3]
    ...
    \| v \|_{ \mathcal{T} _{h} }^{  } \lesssim + \| v \|_{ g_{h} }^{  }
    \]
\end{assumption}
