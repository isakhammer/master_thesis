...
Let the bilinear form $a_{h}: V_{h} \times V_{h} \to \mathbb{R} $  and the linear form $l_{h}: V_{h} \to \mathbb{R} $. We denote the symmetric interior penalty discontinuous Galerkin Poisson formulation to be
...
For more information about the derivation, see \cite[Chapter 4.2]{pietro2012}. Keep in mind that \eqref{eq:poisson_DG} is generally defined on fitted meshed, i.e., meshes that fully
