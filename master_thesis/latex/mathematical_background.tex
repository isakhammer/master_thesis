...
\begin{lemma}[General inverse inequality ]
    \label{lemma:inverse-inequality}
...
\begin{lemma}[General facet inverse inequality ]
    \label{lemma:inverse-inequality}
    Let $\alpha = ( \alpha _{1}, \ldots, \alpha _{N}) $ and $\beta = ( \beta _{1}, \ldots, \beta _{2} ) $.
    Assume $u \in H^{\abs{ \beta  }  }( T) $. Does the following inverse inequality hold.
    \[
    \]
\end{lemma}
