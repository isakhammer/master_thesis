...
\begin{equation}
\| u - u_{h} \|_{ V_{h}  }^{  }  \lesssim  \inf_{v_{h} \in V_{h} } \|  v_{h} - u \|_{V  }^{  }.
\end{equation}
...
\]
In that case will $\| u - u_{h} \|_{ V  }^{  }  \to  0$, $h \to  0$. Hence, if this requirement is fulfilled, the numerical methods will converge towards the unique solution.
