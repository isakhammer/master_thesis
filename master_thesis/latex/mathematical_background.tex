...
\right\}_{i=1}^{d} $ is the standard Cartesian basis in $ \mathbb{R} ^{d} $. A corresponding reference finite element is defined as $( \hat{T}, \hat{\mathcal{P} }, \hat{\Sigma}   ) $.
...
b$. For an illustration see Figure \ref{fig:affine_mapping}.
...
sides. Hence, any quadrilateral transforms into another quadrilateral where pairs of opposite sides remain parallel, For a counter example, see Figure \ref{fig:nonaffine}.
