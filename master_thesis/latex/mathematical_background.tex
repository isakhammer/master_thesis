...
\mathcal{A} u = f.
\end{equation}
Where the function $f: \Omega \subset \mathbb{R}^n \mapsto \mathbb{R}$. We assume that the function $u: \Omega \rightarrow \mathbb{R}$ satisfies the relation \eqref{eq:strong_abs} pointwise so that $\mathcal{A} u(x)=f(x) \forall x \in \Omega$.
