...
For clarity and to not confuse the norm with Sobolev spaces will we generally denote the notation $\| \cdot  \|_{ \mathbb{R} ^{N} }^{  } := \| \cdot  \|_{ 2 }^{  }   $ for the discrete $l^2$-norm.
