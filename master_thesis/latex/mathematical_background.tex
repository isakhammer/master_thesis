...
The Frobenius inner product for for two tensors $A, B \in \mathbb{R} ^{\overbrace{n \times n \times \ldots \times n}^{r \text{ times }} } $ is defined such that $ A:B = \sum_{1\le  i_{1}, \ldots, i_{r} \le  d}^{} A_{i_{1} \ldots i_{r}} B_{i_{1}
    \ldots
i_{r}}  $.
} of Jacobian matrices, respectively.
...
\int_{\Omega }^{} D^r v : D^r v \ dx$ is defined via the standard Frobenius inner product. Observe that this notations holds such that $D^{0} v = v$ and $ D^{1} v = \nabla v $.
...
We can express several general useful basic inequalities.
\begin{enumerate}[label=(\roman*)]
    ...
    \item Let $v \in  H^{r}( \Omega ) $, then is
        \begin{equation}
            \| D^{r}v \|_{\Omega   }^{  }  \lesssim \| v \|_{r,\Omega   }^{  }.
        \end{equation}
