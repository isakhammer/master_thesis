...
function main()
  ...
  p1 = plot(its_circle[1:end-1], data_circle.Delta_uhs[2:end], size=default_size, xscale=:log10, xlabel=L"$t/\tau$", ylabel=L"$\Delta u^m$", legend=false, linecolor = :red)
    ...
    p3 = plot(its_circle, data_circle.Es,size=default_size, xscale=:log10,  xlabel=L"$t/\tau$", ylabel=L"$E^m$", legend=false, linecolor = :red)
    ...
    p4 = plot(its_circle[1:end-1], data_circle.Es[1:end-1] .- data_circle.Es[2:end], size=default_size, xscale=:log10,   xlabel=L"$t/\tau$", ylabel=L"$\delta E^m$", legend=false, linecolor = :red)
    ...
    p5 = plot(its_circle,  data_circle.E1s, size=default_size,   xscale=:log10, legend=false, ylabel=L"$E_1^m$", xlabel=L"$t/\tau$", linecolor = :red)
    ...
    p6 = plot(its_circle, data_circle.E2s, size=default_size, label = "Circle", xscale=:log10, ylabel=L"$E_2^m$", xlabel=L"$t/\\tau$", linecolor = :red)
