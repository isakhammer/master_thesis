...
function main()
    ...
    p1 = plot(its_circle, data_circle.e_u_ts, size=default_size, xlabel=L"$t/\tau$", ylabel=L"$e_{u}$", legend=false, linecolor = :red)
    plot!(p1, its_flower, data_flower.e_u_ts, linecolor = :blue)
