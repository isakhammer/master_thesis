...
\begin{tikzpicture}
    ...
    \draw (center) -- (A1) -- (A2) -- (center);
    \draw (center) -- (A2) -- (A3) -- (center);
    \draw (center) -- (A3) -- (A4) -- (center);
    \draw (center) -- (A4) -- (A5) -- (center);
    \draw (center) -- (A5) -- (A6) -- (center);
    \draw (center) -- (A6) -- (A1) -- (center);
    ...
    \begin{scope}[shift={(2.5,0)}]
        ...
        % Draw the individual edges
        \draw (center) -- (B1) -- (B2) -- (center);
        \draw (center) -- (B2) -- (B3) -- (center);
        \draw (center) -- (B5) -- (B6) -- (center);
        \draw (center) -- (B6) -- (B1) -- (center);
    \end{scope}
    ...
    \fill (C1) circle (2pt);
    \fill (C2) circle (2pt);
    \draw[-, line width=2pt, >=stealth] ($(C2)$) to[bend right] node[midway, above, yshift=0.1cm] {$\Gamma $} ($(C1)$);
