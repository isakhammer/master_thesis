...
\begin{figure}
    ...
    \begin{tikzpicture}
        ...
        \fill[green!30] (center) --(A1) -- (A2) -- (A3) -- (A4)  -- cycle;
        \fill[blue!30] (center) -- (A4) --(A5)--(A6)-- (A7) -- (A1) -- cycle;

        % Draw the individual edges
        \draw[dotted, line width=1.5pt] (center) -- (A1) -- (A2);
        \draw[dotted, line width=1.5pt] (center) -- (A2) -- (A3);
        ...
        \begin{scope}[shift={(2.5,0)}]
            ...
            \fill[green!30] (center) --(B6) -- (B1) -- (B2) --(B3) -- cycle;
            \fill[blue!30] (center) -- (B5) --(B6) -- cycle;


            % Draw the individual edges
            \draw[dotted, line width=1.5pt] (center) -- (B1) -- (B2);
            \draw[dotted, line width=1.5pt] (center) -- (B2) -- (B3)--(center);
            \draw (center) -- (B5) -- (B6);
...
\caption{Illustration of $\mathcal{F} _{h}^{g}$ denoted as the dotted lines. The set is defined as all facets which belongs to cut cells $\mathcal{T} _{\Gamma }$ .  }
