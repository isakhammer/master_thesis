...
\begin{theorem}
    ...
    Let $u \in H^{s}( \Omega ) $ , $s\ge 3$ a solution to \eqref{eq:bi_weak} and let $u \in V_{h}$ of order $k\ge 2$ be the solution to \eqref{eq:Bi_a_h}. Then for $r = \min_{}\{s, k+1\} $ the error $e = u - u_{h}$ satisfies
    \begin{align}
