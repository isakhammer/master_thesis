...
Hence, the first part of the proof is complete.
 ...
 Here is the regularity of $\psi $ and $e$ a consequence of the assumptions of the regularity of $u$ and $u_{h}$  \cite[pp. 113]{brenner2012}.
        ...
        & \lesssim    \underbrace{\|u-u_{h}  \|_{a_{h},*  }^{  }}_{\mathrm{I}_{a} }   \underbrace{\| \psi  - C^{e}_{h}\psi \|_{a_{h},*  }^{  }}_{\mathrm{I}_{b} }
            \end{split}
        \end{equation}
        Now, for $\mathrm{I} $ we simply apply the energy a priori estimate \eqref{eq:bi_apriori_1}
        \begin{equation}
            \label{eq:ni_2}
