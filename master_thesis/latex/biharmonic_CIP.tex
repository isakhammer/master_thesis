...
We will now assemble the Hessian CIP formulation. Let $u \in H^{4}( \Omega ) $ and  $v_{h} \in V_{h}$ and assume that $g_{1} = 0$, then we have the following bilinear and linear forms
\begin{equation}
