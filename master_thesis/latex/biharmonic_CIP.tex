...
&= \sum_{i = 1}^{d}  ( \partial_n  \partial _{x_{i}} u, \nabla  \partial _{x_{i}} v ) _{\Gamma } -   ( \nabla \partial _{x_{i}} u, \nabla \partial _{x_{i}} v )_{\Omega }
= (  \partial_n\nabla u, \nabla v ) _{\Gamma  } - ( D^2 u, D^2v ) _{\Omega } \\
&= ( \partial _{nn} u, \partial _{n} v  )_{\Gamma  }   + ( \partial _{nt} u, \partial _{t} v ) _{\Gamma  } - ( D^2u, D^2v ) _{\Omega } .
    \end{split}
.\end{equation*}
