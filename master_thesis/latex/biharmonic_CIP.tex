...
\end{equation}
Taking into account the boundary conditions do we end up with the following corresponding weak formulation of the biharmonic problem \eqref{eq:bi_problem}.
