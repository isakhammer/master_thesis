...
\begin{split}
    ...
    & - ( \partial _{nn} u , \partial _{n} v_h)_{\Gamma  } - (\partial _{nn} v_h , \partial _{n} u)_{\Gamma  }  + \frac{\gamma }{h}  \left(  \partial _{n} u,  \partial _{n} v      \right)_{\Gamma }
\end{split}
\end{equation}
...
\[
    \begin{split}
( \Delta ^2 u, v ) _{\Omega }  =& ( \Delta u, \Delta v)_{\mathcal{T} _{h} } \\
...
\right)_{\mathcal{F}_{h}^{int} } + \frac{\gamma }{h} ( \partial _{n} u, \partial _{n}v)_{\Gamma }\\
& - ( \partial _{n} v, \Delta u)_{\Gamma }- ( \partial _{n} u, \Delta v)_{\Gamma } + ( \partial _{n} u, \partial _{n} v)_{\Gamma } + \frac{\gamma }{h} ( g_{1} , \Delta v)_{\Gamma } + ( g_{2} , v )_{\Gamma }  .
    \end{split}
\]
\end{lemma}
