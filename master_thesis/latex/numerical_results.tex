...
\begin{figure}[h!]
    \centering
    \input{figures/tex_plots/conv_plot.tex}
...
\begin{figure}
    \centering
    \subfloat[Evolution of condition number]{
        \label{subfig:cond}
        \input{figures/tex_plots/no_penalty_cond_trans.tex}
    }
    \hfill
    \subfloat[Evolution of error number]{
        \label{subfig:error}
