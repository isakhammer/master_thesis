...
\]
Assume that $A $ is invertible, then we define the condition number s.t., \[
\kappa ( A) = \| A  \|_{ 2 }^{  } \| A ^{-1} \|_{ 2 }  .
\]
From linear algebra is a well known result that $ \| A \|_{ \infty }^{  }  \le \| A \|_{2  }^{  } \le \sqrt{N}  \| A \|_{\infty  }^{  }  $, hence, we can bound the condition number applying the $l^{\infty}$ norm,
\[
\| A \|_{ \infty }^{  }\| A^{-1} \|_{ \infty }^{  } \le  \kappa ( A) \le N \| A \|_{ \infty }^{  }\| A^{-1} \|_{ \infty }^{  }   .
\]
\begin{remark}
