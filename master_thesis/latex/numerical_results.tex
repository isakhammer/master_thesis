...
\end{table}
\begin{figure}
\input{results/eoc-test/eoc-hessian-circle-L-3.11-gamma0-20-gamma1-10-gamma2-0.1/conv-plot.tex}
\caption{Convergence rates for the Hessian-based method applied to the circular domain with side length $L=3.11$, using parameters $\gamma=20$, $\gamma_1=10$, and $\gamma_2=0.1$}
\end{figure}
...
\end{table}
\begin{figure}
\input{results/eoc-test/eoc-laplace-circle-L-3.11-gamma0-20-gamma1-10-gamma2-0.1/conv-plot.tex}
\caption{Convergence rates for the Laplacian-based method applied to the circular domain with side length $L=3.11$, using parameters $\gamma=20$, $\gamma_1=10$, and $\gamma_2=0.1$}
\end{figure}
...
\caption{Convergence rates for the Laplacian-based method applied to the Flower domain with side length $L=3.11$, using parameters $\gamma=20$, $\gamma_1=10$, and $\gamma_2=0.1$}
\end{table}
\begin{figure}
\input{results/eoc-test/eoc-laplace-flower-L-3.11-gamma0-20-gamma1-10-gamma2-0.1/conv-plot.tex}
\caption{Convergence rates for the Laplacian-based method applied to the Flower domain with side length $L=3.11$, using parameters $\gamma=20$, $\gamma_1=10$, and $\gamma_2=0.1$}
\end{figure}
...
\begin{figure}
    ...
    \begin{tikzpicture}[scale=0.9]
        ...
        \draw[black,line width=0.8pt, opacity=1.0 ] (0.1, 0.1) circle (0.9cm);
        \draw[black,line width=0.8pt, opacity=0.7 ] (0.4535, 0.4535) circle (0.9cm);
        \draw[black,line width=0.8pt, opacity=0.3 ] (0.807, 0.807) circle (0.9cm);
        \draw[black,line width=0.8pt, opacity=0.2 ] (1.16, 1.16) circle (0.9cm);
        ...
        \draw[->, thick] (p0) -- (p1) node[above] {$\delta$};
        % Background mesh
        \foreach \i in {-2.5, -2, ..., 2.5} {
            \draw[line width=0.1pt, shift={(-2.5,\i)}, opacity=0.2] (0,0) -- (5,0);
            \draw[line width=0.1pt, shift={(\i,-2.5)},opacity=0.2] (0,0) -- (0,5);
    ...
    \end{tikzpicture}
    \caption{Illustration of the translation test with translation $\delta = 2 \sqrt{2}h  $ }
\end{figure}
...
\subfloat[]{%
\input{"results/translation-test/hessian-n-16-it-500-L-3.11/translation-error.tex"}
}

\subfloat[]{%
\input{"results/translation-test/hessian-n-16-it-500-L-3.11/translation-cond.tex"}
}
...
\subfloat[]{%
\input{"results/translation-test/laplace-n-16-it-500-L-3.11/translation-error.tex"}
}

\subfloat[]{%
\input{"results/translation-test/laplace-n-16-it-500-L-3.11/translation-cond.tex"}
}
