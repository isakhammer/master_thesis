...
\subfloat[]{\label{c}
    ...
    \caption{Square background mesh with length $L$ with number of elements $n$ axis and a domain $\Omega $ defined as a circle with radius $R$ with three refinements of $n$.}
\end{figure}
