...
To test the stability of the method during bad cut configurations (see Figure \ref{fig:intersection-example}), will we introduce the so-called translation test. The idea is the
