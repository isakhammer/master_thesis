...
$e_{L^{1}(\Omega)}$ shows small deviations of the numerical solution $u_h(x, t)$ from the initial condition $u(x, 0)$ is very small is in the order of $10^-5$ demonstrating that the mass is conserved. We also observe that the energy functional $E(u_h)$ decreases over time, signifying the system's tendency to seek a state of minimal energy.
