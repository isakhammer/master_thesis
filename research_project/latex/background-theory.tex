...
functional both in space and time, i.e., $\mathcal{J}\left( \Gamma \left( t_{2} \right)  \right) \le   \mathcal{J}\left( \Gamma \left( t_{1} \right)$ for all  $t_{2} > t_{1}$. For for information about gradient flows please check out \cite{dogan2007discrete, dogan2005finite}
