...
\]
For instance, in the case presented in \eqref{eq:WE} we define $\varphi = H ^2$. The shape derivative of this energy functional at some time $t$ in the direction of the velocity-field $v$ from \eqref{eq:vel} is defined as \[
